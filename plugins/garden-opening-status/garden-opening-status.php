...
final class Garden_Opening_Status_V3 {
    ...
    public static function init() {
        ...
        add_filter('aioseo_title', [__CLASS__, 'filter_aioseo_access_page_title'], 107);
        ...
        add_filter('aioseo_facebook_tags', [__CLASS__, 'filter_aioseo_access_page_facebook_tags'], 107);
    ...
    /** Search metadata for the Japanese access page. */
    ...
    /** Search metadata for the evergreen admissions notice post. */
    ...
    public static function output_multilingual_seo_marker() {
        ...
        echo "<!-- Garden Opening Status 3.3.1 multilingual SEO active -->\n";
    }
    ...
    public static function seasonal_mobile_bottom_spacer() {
